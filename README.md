About funcargparse-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/funcargparse-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/Chilipp/funcargparse

Documentation: http://funcargparse.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3894&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/funcargparse-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `funcargparse` can be installed with `conda`:
...
```
mamba install funcargparse
```

It is possible to list all of the versions of `funcargparse` available on your platform with `conda`:
...
```
mamba search funcargparse --channel conda-forge
```
...
mamba repoquery search funcargparse --channel conda-forge

# List packages depending on `funcargparse`:
mamba repoquery whoneeds funcargparse --channel conda-forge

# List dependencies of `funcargparse`:
mamba repoquery depends funcargparse --channel conda-forge
```
